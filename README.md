<hr> <div style="text-align: center; gap: 0.5rem">
...
<h1 style="text-align:center">The Red Boar Inn</h1>
...
walking through the gates in search of adventure...</p> <hr>
...
<p>The red boar inn is the most famous inn in these lands and is for anyone who likes gold, adventure and a good beer.</p> <hr>
...
```
pip install flask flask-login flask-sqlalchemy mvc-flask flask-wtf flask-login flask-bcrypt email-validator
```
